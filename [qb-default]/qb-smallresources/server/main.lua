...
-- NEW
-- QBCore.Commands.Add("id", "Get your ID and your CitizenID", {}, false, function(source) 
--     TriggerClientEvent('QBCore:Notify', source, "Character ID: "..QBCore.Functions.GetPlayer(source).PlayerData.citizenid.. " ID: "..source, 'primary', 2000) 
-- end)
...
QBCore.Functions.CreateUseableItem("boatanchor", function(source, item)
    TriggerClientEvent('qb-smallresources:ToggleAnchor', source)
end)
