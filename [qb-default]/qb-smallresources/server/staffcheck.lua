...
QBCore.Commands.Add('joinstaff', "Login as staff (only staff)", {}, false, function(source)
    local src = source
...
QBCore.Commands.Add('leavestaff', "Logout as staff (onfly staff)", {}, false, function(source)
    local src = source
...
QBCore.Commands.Add('checkstaff', "Check online staff (only staff)", {}, false, function(source)
    local src = source
