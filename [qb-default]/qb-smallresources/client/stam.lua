...
-- RegisterCommand('fiks', function()
--     if IsPedDeadOrDying(playerPed, true) or GetEntityHealth(playerPed) <= 100 or exports['esx_ambulancejob']:RipBozo() then -- if player dies with the effect, stop it.
--         SendNUIMessage({
--             action = 'stop_effect'
--         })
--     end
