...
local function ToggleSeatbelt()
    ...
    TriggerServerEvent("InteractSound_SV:PlayOnSource", seatbeltOn and "carbuckle" or "carunbuckle", 0.15)
end
...
RegisterNetEvent('seatbelt:client:UseHarness', function(ItemData, updateInfo)
    ...
    if inveh and class ~= 8 and class ~= 13 and class ~= 14 then
        if not harnessOn then
            ...
            QBCore.Functions.Progressbar("harness_equip", "Attaching Harness", 2600, false, true, {
