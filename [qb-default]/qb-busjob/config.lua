...
Config.DriverXPlow = 0      -- Lowest "Driving" XP granted to player for successful passenger drop-off.
Config.DriverXPhigh = 8     -- Highest "Driving" XP granted to player for successful passenger drop-off.
...
Config.AllowedVehicles = {
    [1] = {model = "coach", label = Lang:t('info.bus')},
    [2] = {model = "airbus", label = Lang:t('info.bus') , price = 15400}
}
