...
function Config.OnPoliceAlert(message)
    ...
    exports['ps-dispatch']:FleecaBankRobbery(message)
end
...
Config.OutlawCooldown = 10 -- The amount of minutes it takes for the cops to be able to be called again after they were called
