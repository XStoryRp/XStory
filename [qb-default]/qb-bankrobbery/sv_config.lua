...
Config.HitsNeeded = 40 -- The amount of powerstation needed to be hit to cause a blackout
Config.BlackoutTimer = 5 -- The amount of minutes a blackout will take until all power comes back
