...
RegisterNetEvent('qb-bankrobbery:client:robberyCall', function(type, coords)
    ...
    if type == "small" then
        ...
        -- Config.OnPoliceAlert(Lang:t("general.fleeca_robbery_alert"))
         exports['ps-dispatch']:FleecaBankRobbery(Lang:t("general.fleeca_robbery_alert"))
    elseif type == "paleto" then
        ...
        exports['ps-dispatch']:PaletoBankRobbery(Lang:t("general.paleto_robbery_alert"))
    elseif type == "pacific" then
        ...
        exports['ps-dispatch']:PacificBankRobbery(Lang:t("general.pacific_robbery_alert"))
    end
    local transG = 250
