...
Config.DisablePrintSupportMessage = true -- Disable print support message (server console)
...
vehicleCustomisationPrices = {
    cosmetics = {price = 400},
    respray = {price = 1000},
    performance = {prices = {3250, 5500, 10450, 15250, 20500, 25000}},
    turbo = {prices = {15000}},
    wheels = {price = 400},
    customwheels = {price = 600},
    wheelsmoke = {price = 15250},
    windowtint = {price = 400},
    neonside = {price = 100},
    neoncolours = {price = 500},
    headlights = {price = 100},
    xenoncolours = {price = 500},
    oldlivery = {price = 2000},
    plateindex = {price = 500,600,700,800,900}
}
