KloudDev.Locations = {
    ["potato"] = {
        ...
        job = "Farmer", -- false to disable, "jobname" to enable
        action = {
            type = "skillCheck", -- "progress" / "skillCheck"
            progressDuration = 5000,
            skillCheckDifficulty = {"medium", "medium", "hard", "hard"}, -- "easy", "medium", "hard"
    ...
    ["cabbage"] = {
        ...
        action = {
            ...
            progressDuration = 5000,
            skillCheckDifficulty = {"medium", "hard", "hard", "medium"}, -- "easy", "medium", "hard"
            skillCheckInputs = {"1", "2", "3", "4"}
        },
        max = 25,
        target = {
...
KloudDev.Trees = {
    ["orange"] = {
        ...
        action = {
            type = "skillCheck", -- "progress" / "skillCheck"
            progressDuration = 5000,
            skillCheckDifficulty = {"hard", "hard", "hard", "hard"}, -- "easy", "medium", "hard"
            skillCheckInputs = {"1", "2", "3", "4"}
        },
        target = {
            label = "Pick Orange",
...
KloudDev.WashLocations = {
    ...
    duration = 6000, -- per item count ex. x1 orange = 3secs, x10 orange = 30secs
    maxWash = 115,
    anim = {
