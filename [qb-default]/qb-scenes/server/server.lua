...
RegisterNetEvent('qb-scenes:server:CreateScene', function(sceneData)
    ...
    TriggerEvent("qb-log:server:CreateLog", "scenes", "New Scene Created", "black", "**".. GetPlayerName(source) .. "** (citizenid: *"..Player.PlayerData.citizenid.."* | id: *"..source.."*) created a new scene; scene: **"..sceneData.text.."**, where: **" .. sceneData.coords .. "**")
