...
HungerFill = { -- How much they fill your hunger
    ["burger-bleeder"] = math.random(15, 35),
    ["burger-moneyshot"] = math.random(10, 20),
...
Config.Zones = {
    ...
    [4] = { coords = vector3(-1195.15, -899.52, 13.89), radius = 0.75, icon = "fa-solid fa-fire-burner", event = "randol_burgershot:client:makeFries", label = "Make Fries", job = "burgershot" },
    [5] = { coords = vector3(-1196.02, -901.48, 13.89), radius = 0.75, icon = "fa-solid fa-box-open", event = "randol_burgershot:client:ingredientStore", label = "Ingredients", job = "burgershot" },
    [6] = { coords = vector3(-1200.05, -902.44, 13.89), radius = 0.75, icon = "fa-solid fa-briefcase", event = "qb-bossmenu:client:OpenMenu", label = "Manage Business", job = {['burgershot'] = 4} },
    ...
    [9] = { coords = vector3(-1199.91, -899.37, 13.89), radius = 0.6, icon = "fa-solid fa-clock", event = "randol_burgershot:clientToggleDuty", label = "Clock In/Out", job = "burgershot" },
