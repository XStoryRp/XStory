...
Config = {
    ...
    ElectricalWork 	= vector4(-297.46, 6391.55, 30.61, 128.2),    -- Location of Blip on map (no need to adjust)
    ...
    tier1XP = 600,                          -- Amount of "Electrical" XP needed to perform Tier 1 work.
    tier2XP = 12000,                         -- Amount of "Electrical" XP needed to perform Tier 2 work.
    tier3XP = 14000,                         -- Amount of "Electrical" XP needed to perform Tier 3 work.
    ...
    --SKILLCHECK--
    --------------
    Skillcheck = false,                      -- Set to "false" if you do not want players to undergo a skillcheck to complete each task.
    -- if "Config.Skillcheck = true", then the following parameters apply:
    ...
    --PROGRESS BARS--
    -----------------
    GetJob = 1500,                          -- Time (in seconds) where 1 second = 1000.             
    ...
    --OUTPUT--
    ----------
    PaymentType = "cash",                    -- Change to "cash" to make the job pay in cash rather than to a player's bank account.
    -------------
    --TIER PREP--
    -------------
    JobCompletePrepLow = 200,                -- Lowest amount of money received for completing a Prep Tier job. 
    JobCompletePrepHigh = 1500,              -- Highest amount of money received for completing a Prep Tier job. 
    TierPrepJobs = 20,                        -- Number of work preparation tasks which need to be completed (recommended: 3+)
    ...
    RareItems = false,                       -- Change to "false" to disable rare item drops.
    ...
    BreakdownLocationsTierPrep = {
        ...
        [20]    = vector4(-295.67, 6390.66, 30.82, 132.29),
        [21]    = vector4(-297.46, 6393.48, 30.82, 124.55),
        [22]    = vector4(-291.4, 6390.61, 30.84, 294.05),
        [23]    = vector4(-300.34, 6390.93, 30.59, 25.39),
	},
	BreakdownLocations = {
        ...
        [17]    = vector4(678.74, 140.68, 80.75, 74.23), 
        [18]    = vector4(-295.67, 6390.66, 30.82, 132.29),
        [19]    = vector4(-297.46, 6393.48, 30.82, 124.55),
	},
    BreakdownLocationsTier2 = {
        ...
        [17]    = vector4(-297.46, 6393.48, 30.82, 124.55),
        [18]    = vector4(-291.4, 6390.61, 30.84, 294.05),
	},  
    BreakdownLocationsTier3 = {
        ...
        [23]    = vector4(-300.34, 6390.93, 30.59, 25.39),
        [24]    = vector4(-210.03, 6360.63, 31.49, 217.42),
        [25]    = vector4(-291.36, 6255.8, 31.46, 228.12),
	},  
}
