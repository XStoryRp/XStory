local Translations = {
    error = {
        ...
        ["onlypoliceandtow"]           = "Only the police And Tow Truckers can do this!",
    },
    tow = {
        ...
        ["impoundlotheader"]           = "Impound Lot",

        ["depotvehicleheader"]         = "Depot Vehicel",
        ["depotvehicletxt"]            = "Depot The Closest Vehicle",
        ["depotvehicletxtnoaccess"]    = "Only Tow Truckers can Depot Vehicles",


        ["impoundvehicleheader"]       = "Impound Vehicle",
        ["impoundvehicletxt"]          = "Impound THe Closest Vehicle",
        ["impoundvehicletxtnoaccess"]  = "Only the Police can Impound Vehicles",

        ["depotvehicle"]               = "Depoting Vehicle..",
        ["impoundvehicle"]             = "Impounding Vehicle..",
    },
    depot = {
