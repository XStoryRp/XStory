...
RegisterNetEvent('dynyx-gym:OpenMemberBuy', function()
    exports['qb-menu']:openMenu({
        {
            id = 1,
            header = "Bine ai venit! Te rog cumpara de mai jos Gym Membership. Succes sa iti faci corpul cum doresti la noi.",
        },
        {
          id = 2,
...
RegisterNetEvent("dynyx-gym:client:Start", function(data)
  ...
  QBCore.Functions.TriggerCallback('dynyx-gym:server:CheckMoney', function(money)
      if money then
        Wait(3000)
        -- QBCore.Functions.Progressbar('random_task', 'Procesam..', 3000, false, false, {
