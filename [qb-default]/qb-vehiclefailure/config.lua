-- Configuration:
Config = {} -- brake , delete if you delete the brake configuration!!!
...
cfg = {
	...
	damageFactorPetrolTank = 0.5,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
	engineDamageExponent = 1.1,					-- How much should the handling file engine damage setting be compressed toward 1.0. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	...
	degradingFailureThreshold = 230.0,			-- Below this value, slow health degradation will set in
	cascadingFailureThreshold = 230.0,			-- Below this value, health cascading failure will set in
	...
	randomTireBurstInterval = 5.0,				-- Number of minutes (statistically, not precisely) to drive above 22 mph before you get a tire puncture. 0=feature is disabled
