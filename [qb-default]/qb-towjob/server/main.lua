...
RegisterNetEvent('qb-tow:server:Impound', function(plate, price, body, engine, fuel)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local value = Config.CitizenImpoundEarn
    ...
    if IsVehicleOwned(plate) then
            ...
            TriggerClientEvent('QBCore:Notify', src, "You earned "..value.." for impound", 'success')
    end
end) 
