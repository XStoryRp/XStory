...
Config.MaxInventoryWeight = 110000 -- Max weight a player can carry (default 120kg, written in grams)
Config.MaxInventorySlots = 46 -- Max inventory slots for a player

Config.CleanupDropTime = 100 * 60 -- How many seconds it takes for drops to be untouched before being deleted
Config.MaxDropViewDistance = 30 -- The distance in GTA Units that a drop can be seen
Config.UseItemDrop = false -- This will enable item object to spawn on drops instead of markers
Config.ItemDropObject = `prop_paper_bag_small` -- if Config.UseItemDrop is true, this will be the prop that spawns for the item
...
Config.General = {
    ...
    TrashBinModels = {
        673826957,865150065,1919238784,-5943724,1380691550,-317177646,-130812911,3792063141,-1096777189, 666561306, 1437508529, -1426008804, -228596739, 161465839,
        651101403,-58485588,218085040,811169045,-14708062,-1187286639,-1426008804,1948359883,1143474856,1329570871,1614656839,1748268526,
    },
    -- Search distance for qb-target
    SearchDistance = 0.8,
    -- How long does it take to search trough trash
    DurationOfSearch = math.random(5000,10000), -- In miliseconds
    -- How long does before player can search again
    SearchCooldown = 1000, -- In miliseconds
    -- Time that trash is refilled and can be searched again
    RefillTime = 50000 -- In miliseconds
}
...
Config.Reward = {
    ...
    -- Money
    Money = {
        Chance = 0.9, -- Chance to get money instead of an item in % (0-100)
        Min = 200,
        Max = 10000
    },
    ...
    -- Items you can get
    ItemList = {
        "water_bottle", "metalscrap", "plastic", "copper", "glass",
        "tunerlaptop","cryptostick","binoculars","lighter","beer","tosti","sandwich",
        "prime-grape", "ironoxide", "joint", "aluminumoxide","twerks_candy","grapejuice"
    }
}
