...
$(document).on("click", ".item-slot", function(e) {
    ...
    if (ItemData !== null && ItemData !== undefined) {
        if (ItemData.name !== undefined) {
            if (newData.name.split("_")[0] == "weapon" || newData.info.type === "drink" || newData.info.type === "food") {
...
(() => {
    ...
    Inventory.dropmaxweight = 150000;
                    ...
                    if (!IsOtherInventory) {
                        if (!IsHotbar) {
                            ...
                            $(".z-hotbar-inventory")
                                ...
                                .css({
                                    width: "100%",
                                    "background-color": HotbarQualityColor,
                                })
                                .find("p")
                                .html(qualityLabel);
                        }
