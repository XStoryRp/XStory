...
-- --             local rndPos = FindSpawnPointForProp(coords, 0)
-- --             for i = 1, 120 do
...
-- --         Citizen.CreateThreadNow(function()
-- --             local rndPos = FindSpawnPointForProp(coords, 1)
-- --             for i = 1, 120 do
...
-- --         Citizen.CreateThreadNow(function()
-- --             local rndPos = FindSpawnPointForProp(coords, 2)
-- --             for i = 1, 120 do
...
-- --         Citizen.CreateThreadNow(function()
-- --             local rndPos = FindSpawnPointForProp(coords, 3)
-- --             for i = 1, 120 do
...
-- --         Citizen.CreateThreadNow(function()
-- --             local rndPos = FindSpawnPointForProp(coords, 4)
-- --             for i = 1, 120 do
...
-- --         end)
-- --         Citizen.CreateThreadNow(function()
-- --             local rndPos = FindSpawnPointForProp(coords, 5)
-- --             for i = 1, 120 do
