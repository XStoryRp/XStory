...
Config.Fuel = "fuel"        -- "fuel","ps-fuel", "LegacyFuel"
Config.ResourcePerms = 'manager' -- permission to control resource(start stop restart)
Config.ShowCommandsPerms = 'manager' -- permission to show all commands
...
-- Give Car
Config.DefaultGarage = "South Rockford"
