...
RegisterNetEvent('qb-admin:client:SendReport', function(name, targetname, src, target, msg)
    TriggerServerEvent('qb-admin:server:SendReport', name, targetname, src, target, msg)
end)