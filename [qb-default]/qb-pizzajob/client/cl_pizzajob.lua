...
CreateThread(function()
    ...
    -- SetBlipSprite(pizzajobBlip, 66)
    -- SetBlipAsShortRange(pizzajobBlip, true)
    -- SetBlipScale(pizzajobBlip, 0.6)
    -- SetBlipColour(pizzajobBlip, 40)
    -- BeginTextCommandSetBlipName("STRING")
    -- AddTextComponentString("I Need A Help!")
...
function PullOutVehicle()
    if ownsVan then
        ...
        QBCore.Functions.SpawnVehicle(Config.Vehicle, function(pizzaCar)
            ...
            SetVehicleNumberPlateText(pizzaCar, tostring(math.random(1, 9))..litters[math.random(1,#litters)]..tostring(math.random(1,9)..litters[math.random(1,#litters)]..tostring(1,9)..litters[math.random(1,#litters)])..litters[math.random(1,#litters)]..litters[math.random(1,#litters)])
            ...
            -- exports['tsp_vehiclekeys']:GiveTempKeys(GetVehicleNumberPlateText(pizzaCar))
            TriggerEvent('mh-vehiclekeyitem:client:CreateTempKey', GetVehicleNumberPlateText(pizzaCar))
            SetVehicleEngineOn(pizzaCar, false, false)
