...
Config.Payment = 10 -- Per Delivery. Totals up and get paid when you return the vehicle.

Config.BossCoords = vector4(538.35, 101.8, 95.54, 164.05) -- The Blip also uses these coords.

Config.Vehicle = "weevil"

Config.VehicleSpawn = vector4(530.29, 109.75, 95.65, 340.23)

Config.FuelScript = 'fuel'
