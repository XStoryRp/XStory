...
RegisterNetEvent("qb-gangmenu:server:withdrawMoney", function(amount)
	...
	if RemoveGangMoney(gang, amount) then
		...
		TriggerEvent('qb-log:server:CreateLog', 'gangmenu', 'Withdraw Money', 'default', Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname .. ' successfully withdrew $' .. amount .. ' (' .. gang .. ')', false)
...
RegisterNetEvent("qb-gangmenu:server:depositMoney", function(amount)
	...
	if Player.Functions.RemoveMoney("cash", amount) then
		...
		TriggerEvent('qb-log:server:CreateLog', 'gangmenu', 'Deposit Money', 'default', Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname .. ' successfully deposited $' .. amount .. ' (' .. gang .. ')', false)
...
RegisterNetEvent('qb-gangmenu:server:HireMember', function(recruit)
	...
	if Target and Target.Functions.SetGang(Player.PlayerData.gang.name, 0) then
		...
		TriggerEvent('qb-log:server:CreateLog', 'gangmenu', 'Recruit', 'default', (Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname).. ' successfully recruited ' .. Target.PlayerData.charinfo.firstname .. ' ' .. Target.PlayerData.charinfo.lastname .. ' (' .. Player.PlayerData.gang.name .. ')', false)
	end
	TriggerClientEvent('qb-gangmenu:client:OpenMenu', src)
end)
