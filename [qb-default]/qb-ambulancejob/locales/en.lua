local Translations = {
    ...
    info = {
        ...
        wep_unknown = 'Unknown',
        respawn_txt = 'Ded: ~r~%{deathTime}~s~ seconds',
        respawn_txtl = 'Ded: ~r~%{time}~s~ seconds',
        respawn_revive = 'HOLD [~r~E~s~] FOR %{holdtime} TO RESPAWN OR WAIT ~r~EMS~w~',
        bleed_out = 'Bleedout:~r~%{time}~s~ seconds',
        ...
        heal_player_a = 'Heal A Player  (Admin Only)',
    },
    mail = {
    ...
    logs = {
        death_log_title = "",
        death_log_message = "%{playername} (%{playerid}) is dead.\n%{killername} has killed %{playername} with a %{weaponlabel} | %{weaponname}",
        knock_log_title = "",
        knock_log_message = "%{playername} (%{playerid}) is knocked.\n%{killername} has knocked %{playername} with a %{weaponlabel} | %{weaponname}",
