...
-- Price  given back when delivered a garbe
Config.DepositPay = 0
...
Config.Peds = {
    {
        model = 's_m_y_garbage',
        coords = vector4(-331.48, -1549.64, 26.72, 192.25),
...
Config.Locations = {
    ...
    ["vehicle"] = {
        ...
        coords = { -- parking spot locations to spawn garbage
            [1] = vector4(-340.05, -1559.60, 25.23, 94.60),
            -- [2] = vector4(-327.55, -1527.69, 27.25, 359.43),
        },
    },
    ["paycheck"] = {
        label = "Payslip Collection",
        coords = vector3(-331.48, -1549.64, 27.72),
    },
    ["trashcan"] ={
        [1] = {
            name = "forumdrive",
...
-- Config.Vehicle = {'trash','brickadet','vwe_trash1'} -- vehicle name used to spawn
Config.Vehicle = 'brickadet'