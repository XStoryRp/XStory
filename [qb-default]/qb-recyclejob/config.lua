Config = {
	...
	OutsideLocation 	= vector4(1048.224, -3097.071, -38.999, 274.810),
	InsideLocation 		= vector4(1073.0, -3102.49, -39.0, 266.61),
	DutyLocation 		= vector4(1048.7, -3100.62, -38.2, 88.02),
	DropLocation 		= vector4(55.55, 6472.18, 31.43, 44.0),

	DrawPackageLocationBlip = true,

	PickupActionDuration 	= math.random(1000, 1050),
	DeliveryActionDuration 	= 1000,
