...
HungerFill = {
    ["beef-taco"] = math.random(10, 30),
    ["chicken-taco"] = math.random(5, 20),
    ["beef-burrito"] = math.random(9, 60),
    ["chicken-burrito"] = math.random(4, 44),
    ["quesadilla"] = math.random(5, 25),
    ["nachos"] = math.random(1, 25),
}

ThirstFill = {
    ["coke-soda"] = math.random(9, 19),
    ["fanta"] = math.random(7, 17),
}
