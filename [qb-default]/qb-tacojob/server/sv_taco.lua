    ...
    if biller.PlayerData.job.name == 'taco' then
        if billed ~= nil then
            if biller.PlayerData.citizenid ~= billed.PlayerData.citizenid then
                ...
                --exports['qb-banking']:addAccountMoney('taco', amount) -- Uncomment and comment out the qb-management one to use renewed-banking
                exports['qb-banking']:AddMoney('taco', amount)
                else
