...
function ToggleCryptoMiner()
 if MinerStatus == true then
        ...
        --     duration = '500'
        -- })
        QBCore.Functions.Notify("The miner has been stopped and now will stop mining coins", 'error', 3500)
        Wait(500)
            MinerStatus = false
            -- print('Stopped Miner')
        MinerStopped()
        ...
        --     duration = '500'
        -- })
        QBCore.Functions.Notify('The miner has been started and now will start mining coins', 'success', 500)
        Wait(500)
            MinerStatus = true
