...
Config.CryptoWithdrawalFee = '0.95' -- This is a percentage of the fee when withdrawing the crypto - e.g 0.90 = 10%
...
Config.RenewedCryptoType = "xcoin" -- "gne" or "shung" or "xcoin" or "lme" - only change if using renewed phone
