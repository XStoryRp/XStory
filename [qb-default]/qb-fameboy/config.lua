...
Config.GamingMachine = {
	...
	-- some cores require a bios, you may pass it in like this
	{
		...
		link = string.format(
			"nui://qb-fameboy/html/ejs.html?url=%s&params=%s&name=%s&id=%s&bios=%s",
	...
	},
	{
		name = "Sonic Advance",
		link = string.format(
			"nui://qb-fameboy/html/ejs.html?url=%s&params=%s&name=%s&id=%s",
...
Config.SuperMachine = {
	{
		name = "Wolfenstein 3D",
		link = string.format(
			"nui://qb-fameboy/html/msdos.html?url=%s&params=%s",
