...
Config.PayPerFueling = math.random(100, 950) -- This is multiplied by the amount of refuels the player does. So if they refuel 5 stations, they will get 5*math.random

Config.FuelScript = 'fuel' -- cdn-fuel or ps-fuel or LegacyFuel

Config.PayType = 'cash' -- Where does the money come from? bank or cash

Config.TruckPrice = 5000 -- Cost of the vehicle to pull out

Config.MaxFuelDeliveries = 10 -- Maximum amount of deliveries before they need to return and refuel
