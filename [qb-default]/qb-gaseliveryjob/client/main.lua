...
AddEventHandler("spawnTruck", function()
    ...
    QBCore.Functions.SpawnVehicle(Config.TrailerToSpawn, function(veh1)
        ...
        local litters = {'A','B','C','D','E','F','G','H','I','J','K','L','M','N','O','P','R','S','T','U','V','W','X','Y','Z'}
        SetVehicleNumberPlateText(veh1, tostring(math.random(1, 9))..litters[math.random(1,#litters)]..tostring(math.random(1,9)..litters[math.random(1,#litters)]..tostring(1,9)..litters[math.random(1,#litters)])..litters[math.random(1,#litters)]..litters[math.random(1,#litters)])
