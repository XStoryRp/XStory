local Translations = {
    error = {
        ...
        not_whitelisted = 'Nu ai statut de whitelist pe acest server , intra pe discord pentru a face o cerere. \nhttps://dsc.gg/spyrp',
    ...
    success = {
        teleported_waypoint = 'Ai fost teleportat la punctul de setat.',
    },
    info = {
        received_paycheck = 'Ati primit salariul in valoare de %{value} $',
        job_info = 'Job: %{value} | Functie: %{value2}',
        gang_info = 'Gang: %{value} | Functie: %{value2}',
        on_duty = 'Ai inceput tura !',
        off_duty = 'Ai iesit din tura!',
        checking_ban = 'Salut %s. Verificam daca ai ban/licenta dvs...',
        join_server = 'Bine ati veni pe comunitatea SpY Romania!',
        checking_whitelisted = 'Verificam contul gasit dupa licenta dvs...',
