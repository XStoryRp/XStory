...
Config.crafting = {
    {
        ...
        showBlip = false, -- whether or not to show the cannabis bagging location blip on the map
    }
}
...
Config.selling = {
    {
        ...
        duration = 1050, -- selling duration in ms
        ...
        showBlip = false, -- whether or not to show the cannabis selling location blip on the map
    }
}
