...
Config.UpdateFrequency = 79                -- Seconds interval between removing values (no need to touch this)
...
Config.XPMenuPosition = 'bottom-left'          -- Change the position of your XP menu ('top-left' or 'top-right' or 'bottom-left' or 'bottom-right')
