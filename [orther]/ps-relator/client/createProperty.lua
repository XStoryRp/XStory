CreateProperty = {
    ...
    PlacingZone = function(self, type)
        ...
        if type == "door" then
            ...
            QBCore.Functions.Notify('Door was set', 'success', 3500)
        elseif type == "garage" then
            ...
            QBCore.Functions.Notify('Garage was set', 'success', 3500)
        end
    ...
    RemoveGarage = function(self)
        ...
        QBCore.Functions.Notify('Garage was removed', 'primary', 3500)
    end,
    ...
    CreateProperty = function(self)
        ...
        QBCore.Functions.Notify('Property was created', 'primary', 3500)
        self:CancelCreating()
    end,
}
