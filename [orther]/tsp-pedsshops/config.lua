...
Config.DataUpdateInterval = 400

Config.Settings = {
    let_players_cutomize_their_pet_after_purchase = false,
    callCompanionDuration = 1, -- sec
    despawnDuration = 2, -- sec
    itemUsageCooldown = 10, -- sec
    minHuntingAbilityLevel = 9, -- level
    PetMiniMap = { showblip = false, sprite = 442, colour = 4, shortRange = true },
    chaseDistance = 40.0,
...
Config.Balance = {
    maximumLevel = 70, -- xp callculation only works util level 99 don't set it to higher values
    afk = {
    ...
    petting_stress_relief = math.random(20, 50)
}
...
Config.core_items = {
    ...
    ['firstaid'] = {
        ...
        settings = {
            ...
            heal_amount = math.random(5,15), --(percent) 25% of their max health
            revive_heal_bonuses = 19 --(additive) base health to stay alive is 100 it mean 100 + revive_amount
        }
    },
    ['groomingkit'] = {
    ...
    ['waterbottle'] = {
        ...
        settings = {
            ...
            thirst_reduction_per_drinking = 2.5, --(additive)
