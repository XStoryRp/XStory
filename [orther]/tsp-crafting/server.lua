...
RegisterNetEvent('crafting:removeCraftingTable', function()
    ...
    TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['crafting_table'], 'remove' , amount)
...
RegisterNetEvent('crafting:receiveItem', function(craftedItem, requiredItems, amountToCraft)
    ...
    for _, requiredItem in ipairs(requiredItems) do
        ...
        TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items[requiredItem.item], 'remove' , amount)
    end
    if canGive then
