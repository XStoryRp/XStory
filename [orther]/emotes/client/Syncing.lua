            ...
            if (distance ~= -1 and distance < 3) then
                if RP.Shared[emotename] ~= nil then
                    ...
                    -- SimpleNotify(Config.Languages[lang]['sentrequestto'] ..
                        ...
                        QBCore.Functions.Notify(Config.Languages[lang]['sentrequestto'] ..
                         GetPlayerName(target) .. " (" .. ename .. ")", 'primary', 7500)
                else
...
AddEventHandler("ClientEmoteRequestReceive", function(emotename, etype, target)
    ...
    QBCore.Functions.Notify(Config.Languages[lang]['doyouwanna'] .. remote .. ")", 'primary', 7500)
    ...
    while isRequestAnim do
        ...
        if timer == 0 then
            ...
            QBCore.Functions.Notify(Config.Languages[lang]['refuseemote'], 'primary', 7500)
        end
