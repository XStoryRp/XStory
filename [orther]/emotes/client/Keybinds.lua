...
if Config.SqlKeybinding then
    ...
    AddEventHandler("rp:ClientKeybindGetOne", function(key, e)
        QBCore.Functions.Notify(Config.Languages[lang]['bound'] ..Config.Languages[lang]['to'] ..firstToUpper(key), 'primary', 7500)
    ...
    function EmoteBindStart(source, args, raw)
        if #args > 0 then
            ...
            if (Config.KeybindKeys[key]) ~= nil then
                ...
                QBCore.Functions.Notify(key .. Config.Languages[lang]['notvalidkey'], 'error', 7500)
            end
        else
            print("invalid")
        end
