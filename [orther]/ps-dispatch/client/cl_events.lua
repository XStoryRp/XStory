...
local function InjuriedPerson()
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = {"EMS", "ambulance", "LEO"} -- type or jobs that will get the alerts
    })
end
...
local function DeceasedPerson()
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = {"EMS", "LEO"} -- type or jobs that will get the alerts
    })
end
...
local function AtmRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = { "police" , "doj" , "fbi" } -- jobs that will get the alerts
    })
end
