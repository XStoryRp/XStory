...
Config.CostMultiplier = 4.0 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
Config.GlobalTax = 16.0 -- The tax, in %, that people will be charged at the pump. (Default: 15% or 15.0)
...
Config.RefuelTime = 1600 -- Highly recommended to leave at 600. This value will be multiplied times the amount the player is fueling for the progress bar and cancellation logic! DON'T GO BELOW 250, performance WILL drop!
...
Config.EmergencyServicesDiscount = {
    ...
    ['discount'] = 1.5, -- % Discount off of price.
...
Config.SyphonKitCap = 80 -- Maximum amount (in L) the syphon kit can fit!
...
Config.JerryCanCap = 100 -- Maximum amount (in L) the jerrycan can fit! (Default: 50L)
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    --     },
    --     electriccharger = nil,
    --     electricchargercoords = nil, --vector4(175.9, -1546.65, 28.26, 224.29),
    --     label = "Gas Station",
    -- },
    [1] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = vector4(46.68, -1604.1, 29.6, 138.68), --vector4(-51.09, -1767.02, 28.26, 47.16),
        label = "Gas Station",
    },
    [2] = {
        zones = {
        ...
        electricchargercoords = vector4(49.28, -1607.85, 29.59, 306.83), --vector4(-514.06, -1216.25, 17.46, 66.29),
        label = "Gas Station",
    },
    [3] = {
        zones = { 
        ...
        cost = 100000,
        shutoff = true,
        pedcoords = { -- vector4(-715.48, -937.23, 19.03, 273.49)
            x = -715.48, 
            y = -937.23,
            z = 18.03,
            h = 273.49,
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(-720.06, -917.09, 17.21, 101.99),
        label = "Gas Station",
    },
    [4] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(279.79, -1237.35, 28.35, 181.07),
        label = "Gas Station",
    ...
    [5] = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(834.27, -1028.7, 26.16, 88.39),
        label = "Gas Station",
    },
    [6] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(1194.41, -1394.44, 34.37, 270.3),
        label = "Gas Station",
    },
    [7] = {
        zones = {
        ...
        cost = 100000,
        shutoff = false,
        pedcoords = { -- vector4(1181.2, -321.39, 69.17, 192.5)
            x = 1181.2, 
            y = -321.39,
            z = 68.21,
            h = 192.5,
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(1168.38, -323.56, 68.3, 280.22),
        label = "Gas Station",
    },
    [8] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(633.64, 247.22, 102.3, 60.29),
        label = "Gas Station",
    },
    [9] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(-2080.61, -338.52, 12.26, 352.21),
        label = "Gas Station",
    },
    -- [10] = {
    --     zones = {
    ...
    --     },
    --     electriccharger = nil,
    --     electricchargercoords = vector4(1159.91, -289.59, 67.98, 13.27),
    --     label = "Gas Station",
    -- },
    [10] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(1714.14, 6425.44, 31.79, 155.94),
        label = "Gas Station",
    },
    [11] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(1703.57, 4937.23, 41.08, 55.74),
        label = "Gas Station",
    },
    [12] = {
        zones = {
        ...
        cost = 100000,
        shutoff = false, 
        pedcoords = { -- vector4(2007.91, 3775.68, 32.4, 37.14)
            x = 2007.91, 
            y = 3775.68,
            z = 31.18,
            h = 37.14,
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(2008.47, 3787.7, 32.18, 301.85),
        label = "Gas Station",
    },
    [13] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(1770.86, 3337.97, 40.43, 301.1),
        label = "Gas Station",
    },
    [14] = {
        zones = {
        ...
        electriccharger = nil,
        electricchargercoords = nil, --vector4(2690.25, 3265.62, 54.24, 58.98),
        label = "Gas Station",
    },
    ...
    --     },
    --     electriccharger = nil,
    --     electricchargercoords = nil, --vector4(1033.32, 2662.91, 38.55, 95.38),
    --     label = "Gas Station",
    -- },
    -- RECENTLY DELETED
    -- [17] = { 
    ...
    [20] = {
        ...
        minz = 136.64,
        maxz = 139.9,
        pedmodel = "csb_customer",
        cost = 100000,
        shutoff = false,
        pedcoords = { -- vector4(-1794.69, 810.77, 138.51, 134.45)
            x = -1794.69,
            y = 810.77,
            z = 137.51,
            h = 134.45,
    ...
    [21] = {
        ...
        electriccharger = nil,
        electricchargercoords = vector4(1159.88, -289.54, 67.98, 12.57),
        label = "Gas Station",
    },
    [22] = {
        zones = {
            vector2(187.42582702637, 6606.89453125),
            vector2(171.98846435547, 6604.2963867188),
            vector2(171.96882629395, 6603.6596679688),
            vector2(172.10818481445, 6602.94921875),
            vector2(180.03012084961, 6604.3608398438),
            vector2(187.54522705078, 6605.6948242188)
        },
        minz = 29.5,
        maxz = 35.9,
        pedmodel = "csb_hugh",
        cost = 100000,
        shutoff = false,
        pedcoords = { -- vector4(172.69, 6601.63, 31.87, 285.41)
            x = 172.69,
            y = 6601.63,
            z = 30.87,
            h = 285.41,
    ...
    [28] = { -- Gabz Ottos Autos Location, Line In If Needed.
        ...
        electriccharger = nil,
       -- electricchargercoords = nil --vector4(837.7554, -793.623, 25.23, 105.22),
