...
data_file 'DLC_ITYP_REQUEST' 'stream/sandygas/sandys_gas_typ.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/sandygas/sandys_gas_typ.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/paletogas/motopatoche1.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/paletogas/biker_patoche_door1.ytyp'
