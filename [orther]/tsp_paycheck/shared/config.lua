...
Config.Ped = {
    { model = 'a_f_y_business_02', coords = vec4(-1083.14, -245.85, 37.76, 210.28), freeze = true, collision = true, scenario = false, anim = false, blip = { toggleBlips = false, name = 'Paycheck Collection', sprite = 500, color = 4, display = 6 } },
    { model = 'a_f_y_business_02', coords = vec4(248.31, 224.54, 106.29, 167.47),   freeze = true, collision = true, scenario = false, anim = false, blip = { toggleBlips = false, name = 'Paycheck Collection', sprite = 500, color = 4, display = 6 } },
