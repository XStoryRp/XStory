...
RegisterNetEvent('prison:client:PrisonBreakAlert', function()
    ...
    Wait(2 * 60000) -- 2 = 2 Minutes before sending News Alert to all clients (players)
    
    local alert = "Boilingbroke: Prison Outbreak!"
    TriggerServerEvent('newsalert', alert)
end)
