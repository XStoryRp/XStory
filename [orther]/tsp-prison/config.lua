...
Config.InteractDistance = 0.9 -- Interact Radius
...
Config.NavigationDisplay = false -- This will only be used if enabled, this is used to help the user find the activity point.
...
Config.Breakout = {
    ...
    time = 90, -- In seconds, at the end of this time, the tunnel will close for other people to climb into.
