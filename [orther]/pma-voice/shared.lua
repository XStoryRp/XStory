...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{ 0.8, "" }, -- Whisper speech distance in gta distance units
		{ 2.5, "" },  -- Normal speech distance in gta distance units
		{ 15.0, "" } -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{ 0.9,  "" }, -- Whisper speech distance in gta distance units
		{ 2.0,  "" },  -- Normal speech distance in gta distance units
		{ 10.0, "" } -- Shout speech distance in gta distance units
	}
end
