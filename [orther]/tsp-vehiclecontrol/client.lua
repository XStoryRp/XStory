...
if UseCommands then
	...
	RegisterKeyMapping('engine', 'Turn Engine ON / OFF', 'keyboard', 'IOM_WHEEL_DOWN')
	...
	RegisterCommand("seat", function(source, args, rawCommand)
		...
		if seatID ~= nil then
			if seatID == 1 then
				QBCore.Functions.Progressbar("switching_seats", "Switching Seats...", math.random(100, 3000), false, true, {
					disableMovement = false,
					disableCarMovement = false,
					disableMouse = true,
					disableCombat = true,
			...
			elseif seatID == 3 then
				QBCore.Functions.Progressbar("switching_seats", "Switching Seats...", math.random(500, 3000), false, true, {
					disableMovement = false,
					disableCarMovement = false,
					disableMouse = true,
					disableCombat = true,
