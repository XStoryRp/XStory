...
try {
    ...
    // if (z.QBCore) 
    // z.utils.log.info("QBCore found! Supported QB commands will be loaded.");
...
on("playerConnecting", async (name, setKickReason, deferrals) => {
    ...
    // deferrals.update(z.utils.replaceGlobals(z, z.locale.checkingWhitelist2.replace(/{name}/g, name)));
    // deferrals.update(z.utils.replaceGlobals(z, z.locale.checkingWhitelist3.replace(/{name}/g, name)));
    await z.utils.sleep(0);
