...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        if (args.sentence) {
            if (args.time < 150) return interaction.reply({ content: "Jail time need to be more than 150 seconds", ephemeral: true });
            ...
            emitNet("mb-oocjail:server:JailPlayer", args.id, parseInt(args.time));
            emitNet("QBCore:Notify", args.id, `You were sent to prison for ${args.time} minutes`);
            ...
            emitNet("mb-oocjail:client:UnJailOOC", args.id);
