...
Config.Settings = {
    ...
    RPM = 0.70, -- the RPM when the pop/antilag gets triggered
    InstallDist = 0.9,
    WebHook = "https://discord.com/api/webhooks/1074263780877410304/7j-Rbiw9xRfBy3FfVEPtTXnty36EpOiGTCP3HhObvPRhrs01I2v6cf6-6mUfTjrWwj6J",
    Commands = {
