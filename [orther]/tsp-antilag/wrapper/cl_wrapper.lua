...
--     local resourceName = "tsp-antilag"
--    if GetCurrentResourceName() == resourceName then
--     print("~g~succes~w~: "..resource.." is fix and I don\'t fund the posibile errors :)")
--     QBCore.ShowSuccess(resource.."~g~succes~w~: Resource is fix and I don\'t fund the posibile errors :)")
--     --   if (GetCurrentResourceName() ~= resourceName) then
--         else if GetCurrentGameName() ~= resourceName then
--             print("r~error~w~: "..resource.." name is not started becouse resource name ~= tsp-antilag")
--          QBCore.ShowError(resource.." ~r~error~w~: resource name is not started becouse resource name ~= tsp-antilag")
--         end
--     end
-- end)
